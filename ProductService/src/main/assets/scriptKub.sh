...
kubectl create -f src/main/assets/postgres.yml --validate=false
kubectl get deployment postgresql -o json
kubectl get service postgresql -o json
kubectl get svc postgresql
kubectl create configmap product-config --from-file=src/main/resources/application.properties